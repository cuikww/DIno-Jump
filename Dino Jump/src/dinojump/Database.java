...
public class Database {
    private static final String DB_URL = "jdbc:mysql://localhost:3306/dino_sql";
    ...
    public static boolean updateBestScore(String username, int newBestScore) {
     ...
     // Method untuk mendapatkan Top 5 Best Scores
    public static List<String> getTop5BestScores() {
